...
public class OpenCvDetector extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        pipeline = new GoalDeterminationPipeline();
    ...
    public static class GoalDeterminationPipeline extends OpenCvPipeline
    {
         ...
         */
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(110,60);
        ...
        public Mat processFrame(Mat input)
        {
            ...
            if(getAnalysis() < ONE_RING_THRESHOLD){
                position = RingPosition.NONE;
            }else if (getAnalysis() > FOUR_RING_THRESHOLD){
